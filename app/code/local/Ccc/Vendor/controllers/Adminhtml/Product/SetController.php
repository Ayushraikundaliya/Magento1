...
class Ccc_Vendor_Adminhtml_Product_setController extends Mage_Adminhtml_Controller_Action
{
	...
	public function indexAction()
	{
        ...
        $this->_addBreadcrumb(
            Mage::helper('vendor')->__('Manage product Sets'),
            Mage::helper('vendor')->__('Manage product Sets'));

        $this->_addContent($this->getLayout()->createBlock('vendor/adminhtml_product_attribute_set_toolbar_main'));
      
        $this->_addContent($this->getLayout()->createBlock('vendor/adminhtml_product_attribute_set_grid'));
	...
	public function addAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('vendor/adminhtml_product_attribute_set_toolbar_add'));
    ...
    public function editAction()
    {
        ...
        $this->_addBreadcrumb(Mage::helper('vendor')->__('vendor'), Mage::helper('vendor')->__('vendor'));
        $this->_addBreadcrumb(
            Mage::helper('vendor')->__('Manage Product Attribute Sets'),
            Mage::helper('vendor')->__('Manage Product Attribute Sets'));

        $this->_addContent($this->getLayout()->createBlock('vendor/adminhtml_product_attribute_set_main'));
