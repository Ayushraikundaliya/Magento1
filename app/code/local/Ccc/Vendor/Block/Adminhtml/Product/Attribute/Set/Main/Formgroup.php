...
class Ccc_Attribute_Block_Adminhtml_Product_Attribute_Set_Main_Formgroup extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->setMethod('post');
        $form->setAction($this->getUrl('*/vendor_group/save'));
        $this->setForm($form);
    }
